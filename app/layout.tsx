...
export const metadata: Metadata = {
  ...
  title: {
    default: "GitHub Unwrapped - Your GitHub Year in Review",
    template: "%s | GitHub Unwrapped",
  },
  ...
  authors: [{ name: "GitHub Unwrapped" }],
  creator: "GitHub Unwrapped",
  publisher: "GitHub Unwrapped",
  robots: {
    index: true,
    follow: true,
    googleBot: {
  ...
  openGraph: {
    ...
    siteName: "GitHub Unwrapped",
    title: "GitHub Unwrapped - Your GitHub Year in Review",
    description: "Discover your GitHub stats, achievements, and coding patterns from the past year with beautiful Spotify-style animations. Track commits, PRs, issues, streaks, and earn developer nicknames.",
    images: [
      {
        url: "/og-image.png",
        width: 1200,
        height: 630,
        alt: "GitHub Unwrapped - Your GitHub Year in Review",
      },
    ],
  },
  twitter: {
